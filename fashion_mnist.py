...
#Fashion MNIST Dataset was used and it was downloaded from Kaggle.com

# Visualize the embedding vectors
from matplotlib import offsetbox

df_origin = pd.read_csv("fashion-mnist_train.csv", header = None, nrows=10000)
...
# Building the clustering model 
spectral_model = SpectralClustering(n_clusters = 5, affinity ='rbf')   
# Training the model and Storing the predicted cluster labels 
